...
export default function ExploreMore(){
    return (
        ...
        <div className="ml-4 mb-24">
            ...
            <p>Discover and book the perfect hostel near your university with ease.</p>
        </div>
        ...
        <div className="ml-4 mb-20 lg:flex justify-between lg:gap-20 mr-5">
            <div className="mb-10 lg:order-2 lg:flex lg:flex-1 lg:items-center ">
                <div>
                    <div>
                        <p className="text-6xl mb-8"><FaCube /></p>
                        <h1 className="text-4xl font-bold mb-5">About Our Website: Solving Hostel Needs.</h1>
                        <p>Our Website was created to address the needs of students and hostel managers. 
                            We provide a platform where students can easily find and book hostels near their university, 
                            while also helping hostel managers effeciently to manage their properties.</p>
                    </div>
        ...
        <div className="ml-4 mb-3">
            <div className="mb-10 w-72 lg:w-full">
                ...
                <p>Dedicated professionals committed to providing a seamless hostel booking experience.</p>
            </div>
            ...
            <div className="lg:grid lg:grid-cols-3 lg:gap-10">
                <div className="mb-10">
                    ...
                    <p>With over 10 years of experince in the hospitality industry, 
                        John leads our team with passion and expertise</p>
                ...
                <div className="mb-10">
                    ...
                    <p>Jane is a tech-savvy professional who ensures our platform is always up-to-date and user friendly.</p>
                    <div className="flex gap-3 mt-4 text-xl">
                        <a><FaLinkedin /></a> 
                        <a><FaXTwitter /></a> 
                        <a><TbWorld /></a> 
                ...
                <div className="mb-10">
                    ...
                    <p>Emily is dedicated to providing exceptional customer support and ensuring smooth booking process for all customers.</p>
                    <div className="flex gap-3 mt-4 text-xl">
                        <a><FaLinkedin /></a> 
                        <a><FaXTwitter /></a> 
                        <a><TbWorld /></a> 
                ...
                <div className="mb-10">
                    ...
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vero quidem itaque recusandae 
                        molestias ipsa dicta non error?
                    </p>
                    <div className="flex gap-3 mt-4 text-xl">
                        <a><FaLinkedin /></a> 
                        <a><FaXTwitter /></a> 
                ...
                <div className="flex overflow-hidden space-x-16">
                    <div className="flex gap-10  justify-center animate-loop-scroll">
                        <div className="flex gap-10">
                            ...
                            <div className="flex items-center gap-2">
                                <span className="text-4xl"><FaCube/></span>
        ...
        <div className="ml-4 my-20 lg:flex justify-between mr-5">
            <div className="mb-10 lg:flex items-center lg:w-2/5">
                <div>
                    <div>
                        <p className="text-6xl mb-8"><FaCube /></p>
                        <h1 className="text-4xl font-bold mb-5">Discover the Benefits of Our Website</h1>
                        <p>Our Website provides a supportive community for students and hostel managers, offering a range of benefits. 
                            With our platform, students can easily find and book hostels near their university, 
                            while hostel managers can effeciently manage their properties and keep track of sudents.</p>
                    </div>
                    <div className="w-96 flex mt-5 gap-4 lg:mt-16">
                        <button className="border-2 border-black p-2 hover:bg-black hover:text-white transition ease-in-out duration-300">Learn More</button>
                        <button className="flex items-center gap-3 transition ease-in-out duration-300">Sign Up <GoChevronRight /> </button>
        ...
        <div className="my-32">
            ...
            <div className="flex justify-center mt-4 space-x-2">
                <div className="cursor-pointer w-4 h-4 rounded-full bg-gray-300" id="radio1"></div>
                <div className="cursor-pointer w-4 h-4 rounded-full bg-gray-300" id="radio2"></div>
                <div className="cursor-pointer w-4 h-4 rounded-full bg-gray-300" id="radio3"></div>
                <div className="cursor-pointer w-4 h-4 rounded-full bg-gray-300" id="radio4"></div>
                <div className="cursor-pointer w-4 h-4 rounded-full bg-gray-300" id="radio5"></div>
            </div>
        </div>
        ...
        <div className="ml-4 mb-32 mt-10 lg:mt-32 lg:flex justify-between">
            <div>
                <h1 className="font-bold text-3xl mb-5">Experience the best hostel life</h1>
                <p>Book your ideal hostel and enjoy a comfortable stay</p>
            </div>
            <div className="flex gap-5 mt-5 lg:mr-10">
                <button className="bg-black py-2 px-10 text-white hover:border-2 hover:border-black hover:text-black hover:bg-inherit transition ease-in-out duration-300">Explore</button>
                <button className="border-2 border-black px-10 py-2 hover:bg-black hover:text-white transition ease-in-out duration-300">Contact</button>
            </div>
        </div>
