    ...
    <header className="block lg:flex items-center gap-10 px-2 lg:border-b-[1px] border-slate-500 bg-gradient-to-l from-[#4A90E2] to-[#1A355E] text-[#FAF9F6] h-[90px]">
      ...
      <nav className="flex flex-col lg:flex-row lg:items-center justify-between w-full ">
        ...
        <div className="flex flex-col lg:flex-row py-8 gap-5">
          <button className="border-[1px] border-black bg-white py-2 px-5 text-[#1A355E] font-semibold">Sign Up</button>
          <Link href="/login"><button className="border-[1px] border-black bg-[#1A355E] text-white800 py-2 px-5">Log In</button></Link>
        </div>
      </nav>
    </header>
