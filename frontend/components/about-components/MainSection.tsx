...
export default function MainSection() {
  return (
    ...
    <section>
      <section className="py-20 px-3 block lg:flex gap-10 lg:px-20">
      ...
      <div className="text-center">
        <small className="text-lg font-semibold text-center">Affordable</small>
    ...
    <section className="flex flex-col lg:flex-row px-3 lg:px-36 justify-between gap-5 lg:items-center py-32">
      <div>
        <h1 className="text-4xl font-semibold py-3">Find Your Perfect Hostel</h1>
        <p className="text-xl">Book a Comfortable and Affordable Hostel</p>
      </div>
      <div className="flex gap-5">
        <button className="bg-black px-6 py-3 text-white text-lg">Reserve</button>
        <button className="border-[1px] border-black text-lg px-6 py-3">Learn More</button>
      </div>
    </section>

    <section className="flex flex-col justify-between px-4 lg:flex-row lg:px-28 pt-20 gap-10">
    <div className="flex-[1]">
      <h2 className="text-4xl py-2 font-semibold">Frequently Asked Questions</h2>
      <p className="py-3">Find answers to common questions about booking a hostel.</p>
  ...
  <section className="flex items-center justify-center w-full h-full">
    ...
    <h1 className="text-xl lg:text-3xl lg:w-[850px] text-center md:w-[600px] md:mx-auto font-semibold py-6 leading-snug">I was able to book a hostel through the website. It made the whole process hassle-free.</h1>
    <Image src={Profile} alt="image" className="w-[80px] h-[80px] rounded-full object-cover mx-auto" />
  ...
  <section className="px-3 py-40 lg:px-10">
    <div className="flex flex-col justify-between lg:flex-row">
     <div>
     <h1 className="text-4xl font-semibold py-3">Stay updated with hostel bookings</h1>
      <p>Sign Up for booking confirmation and updates</p>
     </div>

    <div>
     <div className="flex gap-5 items-center">
      <input type="email" placeholder="Enter your email" className="border-[1px] border-black w-full px-3 h-[50px] lg:w-[500px]"/>
      <button className="bg-black text-white w-full py-4 my-4 lg:my-0 cursor-pointer lg:w-[150px]">Subscribe Now</button>
     </div>
     <p className="py-2 text-[13px] lg:text-lg">By subscribing, you agree to our Terms and Conditions</p>
     </div>
    </div>
  </section>
